  ...
  constructor() {
    ...
    this.state = {
      ...
      experience: [
        {
          id: uniqid(),
          company: 'Company that Employs Cats',
          title: 'Senior Cat Food Tester',
          date: 'Sept 2022 - Aug 2025',
          location: 'Topeka, KS',
          desc: 'Tested cat foods for the greater good of cat-kind... Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore...'
        },
        {
          id: uniqid(),
          company: 'Another Cat Employment Company',
          title: 'Junior Cat Food Tester',
